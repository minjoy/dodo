    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="px-4 py-6 space-y-6">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <Link
            href="/my/region"
            className="w-full flex items-center gap-4 px-5 py-4 border-b border-gray-50 hover:bg-gray-50 transition-colors"
          >
      ...
      {/* 레벨 설명 모달 */}
      {showLevelModal && (
        <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/50 p-4 pt-16 pb-24">
          <div className="bg-white rounded-3xl w-full max-w-sm max-h-full flex flex-col overflow-hidden">
